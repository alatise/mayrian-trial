...
import logo from "../assets/pdbs-logo.svg";
...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center mx-auto px-8 my-8">
      ...
      <ul
        className={
          nav
            ? "absolute md:hidden left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500"
